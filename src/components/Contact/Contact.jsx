      ...
      <section class="bg-background text-foreground">
        ...
        <form action="#" class="space-y-8">
          <div>
            ...
            <input type="email" id="email" className="shadow-sm  border border-gray-300  text-sm rounded-lg focus:ring focus:border-border block w-full p-2.5" placeholder="name@flowbite.com" required />
          </div>
          <div>
